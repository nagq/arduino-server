...
const index_ov2640_html_gz = Buffer.from([
...
const index_ov3660_html_gz = Buffer.from([
...
const index_ov5640_html_gz = Buffer.from([
...
[index_ov2640_html_gz, index_ov3660_html_gz, index_ov5640_html_gz].forEach(str => {
    // 使用 zlib.gunzip 进行解压缩
    zlib.gunzip(str, (err, decompressedData) => {
        if (err) {
